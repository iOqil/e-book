#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""React Native kitobi markaziy QA: kirill, BOM, font<13, cross-link, SVG XML, rasm, nav."""
import os, re, glob
import xml.etree.ElementTree as ET

BOOK = r"C:/Users/imomn/Desktop/e-books/docs/react-native"
...
for k,label in labels.items():
    ...
    print(f"\n### {label}: {len(items)}")
    for it in items[:50]: print("  -", it)
    if len(items) > 50: print(f"  ... +{len(items)-50}")
